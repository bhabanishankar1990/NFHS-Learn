...
public class Registration_Account_Setup6 extends TestSuiteBase
{
	...
	@Test(dataProvider="registration_Account_Setup6_Test_Data")
	...
	public void reportTestCaseResult() throws InvalidFormatException, IOException
	{
	   ...
	   @DataProvider 
	   public Object[][] registration_Account_Setup6_Test_Data()
	   {
		   Object[][] data=TestUtil.getData(System.getProperty("user.dir")+"\\src\\com\\NFHS\\xls","Registration","Registration_Account_Setup6");
	       return(data);
	   }
