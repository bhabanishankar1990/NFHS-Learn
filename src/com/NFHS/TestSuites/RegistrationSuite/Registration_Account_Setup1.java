...
public class Registration_Account_Setup1 extends TestSuiteBase
{
	...
	@Test(dataProvider="registration_Account_Setup1_Test_Data")
		...
		APP_LOGS.info("----Executing Testcase---- :"+this.getClass().getSimpleName()+"----");
	         ...
	         homepage=new HomePage(driver);
	                    ...
	                    try
	                      ...
	                      String confirmemailerror=rp.registerUserMatchEmailAddressError(emailaddress, confirmemailaddress, password, confirmpassword);  
	                      
	                      Assert.assertEquals(confirmemailerror,"Email and confirm email is not matching");
	                      }
	                     catch(Throwable t)
			     	       {
			     	        	  fail=true;
	...
	public void reportTestCaseResult() throws InvalidFormatException, IOException
	{
	   ...
	   @DataProvider 
	   public Object[][] registration_Account_Setup1_Test_Data()
	   {
		   Object[][] data=TestUtil.getData(System.getProperty("user.dir")+"\\src\\com\\NFHS\\xls","Registration","Registration_Account_Setup1");
	       return(data);
	   }
