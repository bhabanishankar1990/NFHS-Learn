...
public class Registration_Account_Setup4 extends TestSuiteBase
{
	String Runmodes[];
	int count=0;
	...
	@Test(dataProvider="registration_Account_Setup4_Test_Data")
	...
	public void reportTestCaseResult() throws InvalidFormatException, IOException
	{
	   ...
	   @DataProvider 
	   public Object[][] registration_Account_Setup4_Test_Data()
	   {
		   Object[][] data=TestUtil.getData(System.getProperty("user.dir")+"\\src\\com\\NFHS\\xls","Registration","Registration_Account_Setup4");
	       return(data);
	   }
