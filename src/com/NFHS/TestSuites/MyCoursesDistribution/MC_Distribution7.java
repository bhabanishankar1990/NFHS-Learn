...
public class MC_Distribution7 extends TestSuiteBase
{
	...
	@Test(dataProvider="mc_Distribution7_Test_Data")
	public void mc_Distribution7(String username,String password,String invoicenumber,String firstname,String lastname,String email) throws Exception
	{   
	   ...
	   try
	      {
	    		...
	    		String error_message=uap.send_Available_Course_Pending_State(invoicenumber, firstname, lastname, email);
	    		Assert.assertEquals(error_message,"This user already has this course in pending state.");
	    		uap.signOut();
	...
	@DataProvider
	public Object[][] mc_Distribution7_Test_Data()
	{
		Object[][] data=TestUtil.getData(System.getProperty("user.dir")+"\\src\\com\\NFHS\\xls","MC Distribution","MC_Distribution7");
	    return(data);
	}
}
