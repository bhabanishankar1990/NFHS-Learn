...
public class MC_Distribution4 extends TestSuiteBase
{
	...
	@Test(dataProvider="mc_Distribution4_Test_Data")
	public void mc_Distribution4(String username,String password,String invoicenumber,String firstname,String lastname,String email) throws Exception
	{   
	...
	@DataProvider
	public Object[][] mc_Distribution4_Test_Data()
	{
		Object[][] data=TestUtil.getData(System.getProperty("user.dir")+"\\src\\com\\NFHS\\xls","MC Distribution","MC_Distribution4");
	    return(data);
	}
