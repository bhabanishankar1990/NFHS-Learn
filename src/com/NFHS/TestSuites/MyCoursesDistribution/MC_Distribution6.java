...
public class MC_Distribution6 extends TestSuiteBase
{
	String Runmodes[];
	int count=0;
	...
	@Test(dataProvider="mc_Distribution6_Test_Data")
	public void mc_Distribution6(String username,String password,String invoicenumber,String firstname,String lastname,String email) throws Exception
	{   
	   ...
	   try
	      {
	    		...
	    		Assert.assertEquals(error_message,"An email with a link to redeem this course has been sent to this user.");
	    		uap.signOut();
	...
	@DataProvider
	public Object[][] mc_Distribution6_Test_Data()
	{
		Object[][] data=TestUtil.getData(System.getProperty("user.dir")+"\\src\\com\\NFHS\\xls","MC Distribution","MC_Distribution6");
	    return(data);
	}
}
