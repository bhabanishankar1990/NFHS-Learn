...
public class MC_Distribution2 extends TestSuiteBase
{
	String Runmodes[];
	int count=0;
	...
	@Test(dataProvider="mc_Distribution2_Test_Data")
	public void mc_Distribution2(String username,String password,String invoicenumber) throws Exception
	{   
	   ...
	   try
	   {
	    		...
	    		boolean available_box=uap.check_Available_Courses(invoicenumber);
	    		Assert.assertEquals(available_box,true);
	    		uap.signOut();
	...
	@DataProvider
	public Object[][] mc_Distribution2_Test_Data()
	{
		Object[][] data=TestUtil.getData(System.getProperty("user.dir")+"\\src\\com\\NFHS\\xls","MC Distribution","MC_Distribution2");
	    return(data);
	}
