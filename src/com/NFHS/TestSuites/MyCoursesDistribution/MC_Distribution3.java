...
public class MC_Distribution3 extends TestSuiteBase
{
	...
	@Test(dataProvider="mc_Distribution3_Test_Data")
	public void mc_Distribution3(String username,String password,String invoicenumber) throws Exception
	{   
	   ...
	   try
	      {
	    		...
	    		String error_message=uap.send_Available_Course_Blank(invoicenumber);
	...
	@DataProvider
	public Object[][] mc_Distribution3_Test_Data()
	{
		Object[][] data=TestUtil.getData(System.getProperty("user.dir")+"\\src\\com\\NFHS\\xls","MC Distribution","MC_Distribution3");
	    return(data);
	}
