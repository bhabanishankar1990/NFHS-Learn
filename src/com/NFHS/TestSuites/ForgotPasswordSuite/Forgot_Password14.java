...
public class Forgot_Password14 extends TestSuiteBase
{
	String Runmodes[];
	int count=0;
	...
	@Test(dataProvider="forgot_Password14_Test_Data")
	public void forgot_Password_14(String emailaddress,String gpassword,String newpassword,String confirmpassword) throws Exception
	{   
	    		...
	    		Set<String> allwindows=driver.getWindowHandles();
	    			...
	    			for(String windowid:allwindows)
	    			{
	    				if(driver.switchTo().window(windowid).getTitle().equals("NfhsLearn"))
	    				{
	    					...
	    					pb.webElementProperty("change_new_password").sendKeys(newpassword);
	    					pb.webElementProperty("change_confirm_password").sendKeys(confirmpassword);
	    					pb.webElementProperty("change_submit").click();
	    				    String changepwdtext=pb.webElementProperty("password_changed_success").getText();
	    				    pb.webElementProperty("nfhs_logout_drop_down").click();
	    				    pb.webElementProperty("nfhs_logout").click();
	    				    Assert.assertEquals(changepwdtext,"Your password was changed successfully. You are now signed in.");
	    				    driver.close();
	    				}
	    			}
	...
	@DataProvider
	public Object[][] forgot_Password14_Test_Data()
	{
		Object[][] data=TestUtil.getData(System.getProperty("user.dir")+"\\src\\com\\NFHS\\xls","Forgot Password","Forgot_Password14");
	    return(data);
	}
