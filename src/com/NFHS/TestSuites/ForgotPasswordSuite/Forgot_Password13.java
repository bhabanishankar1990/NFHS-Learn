...
public class Forgot_Password13 extends TestSuiteBase
{
	String Runmodes[];
	int count=0;
	...
	@Test(dataProvider="forgot_Password13_Test_Data")
	public void forgot_Password_13(String emailaddress,String gpassword,String newpassword,String confirmpassword) throws Exception
	{   
	    		...
	    		Set<String> allwindows=driver.getWindowHandles();
	    			...
	    			for(String windowid:allwindows)
	    			{
	    				if(driver.switchTo().window(windowid).getTitle().equals("NfhsLearn"))
	    				{
	    				    ...
	    				    boolean mismatch=changepwdtext.contains("Password doesn't match confirmation"
	...
	@DataProvider
	public Object[][] forgot_Password13_Test_Data()
	{
		Object[][] data=TestUtil.getData(System.getProperty("user.dir")+"\\src\\com\\NFHS\\xls","Forgot Password","Forgot_Password13");
	    return(data);
	}
}
