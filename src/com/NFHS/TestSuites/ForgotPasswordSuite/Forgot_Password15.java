...
public class Forgot_Password15 extends TestSuiteBase
{
	String Runmodes[];
	int count=0;
	...
	@Test(dataProvider="forgot_Password15_Test_Data")
	public void forgot_Password_15(String username,String password) throws Exception
	{   
	    ...
	    try
	      {
	         ...
	         String signedIn=uap.signedIn();
	         homepage=uap.signOut();
	         Assert.assertEquals(signedIn,"Signed in successfully.");
	...
	@DataProvider
	public Object[][] forgot_Password15_Test_Data()
	{
		Object[][] data=TestUtil.getData(System.getProperty("user.dir")+"\\src\\com\\NFHS\\xls","Forgot Password","Forgot_Password15");
	    return(data);
	}
}
