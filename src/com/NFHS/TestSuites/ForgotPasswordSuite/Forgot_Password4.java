...
public class Forgot_Password4 extends TestSuiteBase
{
	...
	@Test(dataProvider="forgot_Password4_Test_Data")
	public void forgot_Password_4(String emailaddress) throws Exception
	{   
	...
	@DataProvider
	public Object[][] forgot_Password4_Test_Data()
	{
		Object[][] data=TestUtil.getData(System.getProperty("user.dir")+"\\src\\com\\NFHS\\xls","Forgot Password","Forgot_Password4");
	    return(data);
	}
}
