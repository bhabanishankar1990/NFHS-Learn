...
public class Forgot_Password10 extends TestSuiteBase

{
	...
	@Test(dataProvider="forgot_Password10_Test_Data")
	public void forgot_Password_10(String emailaddress,String gpassword,String newpassword,String confirmpassword) throws Exception
	{   
	    		...
	    		Set<String> allwindows=driver.getWindowHandles();
	    			...
	    			for(String windowid:allwindows)
	    			{
	    				if(driver.switchTo().window(windowid).getTitle().equals("NfhsLearn"))
	    				{
	    					...
	    					WebElement newpwd=pb.webElementProperty("change_new_password");
	    					WebElement confirmpwd=pb.webElementProperty("change_confirm_password");
	    					String newpwd_typeval=newpwd.getAttribute("type");
	    					String confirmpwd_typeval=confirmpwd.getAttribute("type");
	    					Assert.assertEquals(newpwd_typeval,"password");
	    					Assert.assertEquals(confirmpwd_typeval,"password");
	    				    driver.close();
	    				}
	    			}
	...
	@DataProvider
	public Object[][] forgot_Password10_Test_Data()
	{
		Object[][] data=TestUtil.getData(System.getProperty("user.dir")+"\\src\\com\\NFHS\\xls","Forgot Password","Forgot_Password10");
	    return(data);
	}
}
