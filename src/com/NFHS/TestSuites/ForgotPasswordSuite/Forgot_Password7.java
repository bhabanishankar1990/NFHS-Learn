...
public class Forgot_Password7 extends TestSuiteBase
{
	String Runmodes[];
	int count=0;
	...
	@Test(dataProvider="forgot_Password7_Test_Data")
	public void forgot_Password_7(String emailaddress,String gpassword,String newpassword,String confirmpassword) throws Exception
	{   
	    	      ...
	    	      pb.webElementProperty("gmail_email").sendKeys(emailaddress);
	    			...
	    			for(String windowid:allwindows)
	    			{
	    				if(driver.switchTo().window(windowid).getTitle().equals("NfhsLearn"))
	    				{
	    				    ...
	    				    String changepwdtext=pb.webElementProperty("change_password_invalid_token").getText();
	    				    boolean invalidtoken=changepwdtext.contains("Reset password token is invalid");
	    				    Assert.assertEquals(invalidtoken,true);
	    				    driver.close();
	    				}
	    			}
	...
	@DataProvider
	public Object[][] forgot_Password7_Test_Data()
	{
		Object[][] data=TestUtil.getData(System.getProperty("user.dir")+"\\src\\com\\NFHS\\xls","Forgot Password","Forgot_Password7");
	    return(data);
	}
