...
public class Forgot_Password2 extends TestSuiteBase
{
	String Runmodes[];
	int count=0;
	...
	@Test
	public void forgot_Password_2() throws Exception
	{   
	      ...
	      try
	          {
	               ...
	               boolean emailtext=forgotpassword.emailAddressBlankError();
