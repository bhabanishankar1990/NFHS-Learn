...
public class Forgot_Password9 extends TestSuiteBase
{
	String Runmodes[];
	int count=0;
	...
	@Test(dataProvider="forgot_Password9_Test_Data")
	public void forgot_Password_9(String emailaddress,String gpassword,String newpassword,String confirmpassword) throws Exception
	{   
	    		...
	    		Set<String> allwindows=driver.getWindowHandles();
	    			...
	    			for(String windowid:allwindows)
	    			{
	    				if(driver.switchTo().window(windowid).getTitle().equals("NfhsLearn"))
	    				{
	    				    ...
	    				    boolean blankpwd=changepwdtext.contains("Password can't be blank");
	    				    Assert.assertEquals(blankpwd,true);
	    				    driver.close();
	    				}
	    			}
	...
	@DataProvider
	public Object[][] forgot_Password9_Test_Data()
	{
		Object[][] data=TestUtil.getData(System.getProperty("user.dir")+"\\src\\com\\NFHS\\xls","Forgot Password","Forgot_Password9");
	    return(data);
	}
}
