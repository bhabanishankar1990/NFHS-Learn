...
public class Forgot_Password11 extends TestSuiteBase
{
	...
	@Test(dataProvider="forgot_Password11_Test_Data")
	public void forgot_Password_11(String emailaddress,String gpassword,String newpassword,String confirmpassword) throws Exception
	{   
	    		...
	    		Set<String> allwindows=driver.getWindowHandles();
	    			...
	    			for(String windowid:allwindows)
	    			{
	    				if(driver.switchTo().window(windowid).getTitle().equals("NfhsLearn"))
	    				{
	    				    ...
	    				    String changepwdtext=pb.webElementProperty("change_password_blank_error").getText();
	    				    boolean minimumchars=changepwdtext.contains("Password is too short (minimum is 8 characters)");
	    				    Assert.assertEquals(minimumchars,true);
	    				    driver.close();
	    				}
	    			}
	...
	@DataProvider
	public Object[][] forgot_Password11_Test_Data()
	{
		Object[][] data=TestUtil.getData(System.getProperty("user.dir")+"\\src\\com\\NFHS\\xls","Forgot Password","Forgot_Password11");
	    return(data);
	}
}
